        ...
        switch(option){
            case "cm":
                switch(convertir){
                    ...
                    case "m":resultado= numero / 100; document.getElementById("cambiar").innerHTML = resultado;break
            ...
            case "mm":
                switch(convertir){
                    ...
                    case "m":resultado= numero / 1000; document.getElementById("cambiar").innerHTML = resultado;break
